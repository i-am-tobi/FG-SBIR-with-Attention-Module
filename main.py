...
if __name__ == "__main__":
    ...
    parser.add_argument('--backbone_name', type=str, default='VGG_Attention', help='VGG_Attention / InceptionV3/ Resnet50')
    parser.add_argument('--pool_method', type=str, default='AdaptiveMaxPool2d',
                        help='AdaptiveMaxPool2d / AdaptiveAvgPool2d / AvgPool2d')
    parser.add_argument('--root_dir', type=str, default='/home/computer/Desktop/Baseline_FGSBIR/')
